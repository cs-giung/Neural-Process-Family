...
if __name__ == "__main__":
    ...
    if config.datasets.train.gp.data_size is None:
        ...
        log_name = log_name + f'_bs{config.datasets.train.gp.batch_size:04d}'
    else:
        # 500, 250, 125
        log_name = log_name + f'_ni{(config.datasets.train.gp.data_size // config.datasets.train.batch_size * config.train.num_epochs):06d}'
